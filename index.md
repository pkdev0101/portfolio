...
<div class="ocs__links">
    ...
    <a class="ocs__btn alert-green fill" href="{{site.baseurl}}/2026-03-25-college-ready-blog.html">
        College Ready Blog
    </a>

    <a class="ocs__btn alert-yellow fill" href="{{site.baseurl}}/2026-03-25-oop.html">
        Object-Oriented Programming
    </a>

    <a class="ocs__btn alert-red fill" href="{{site.baseurl}}/2026-03-25-coding-practices.html">
        Coding Practices and SDLC
    </a>

    <a class="ocs__btn alert-green fill" href="{{site.baseurl}}/2026-03-25-data-types.html">
        Data Types
    </a>

    <a class="ocs__btn alert-yellow fill" href="{{site.baseurl}}/2026-03-25-control-structures.html">
        Operators & Control Structures
    </a>

    <a class="ocs__btn alert-red fill" href="{{site.baseurl}}/2026-03-25-api-integration.html">
        I/O & API
    </a>

    <a class="ocs__btn alert-green fill" href="{{site.baseurl}}/2026-03-25-documentation-debugging.html">
        Documentation & Debugging
    </a>

    <a class="ocs__btn alert-yellow fill" href="{{site.baseurl}}/2026-03-25-additional-projects.html">
        Additional Projects
    </a>
